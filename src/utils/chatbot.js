...
const STRINGS = {
  fr: {
    ...
    noPostal: (code) => `Je n'ai pas d'opticien Thélios au code postal ${code} pour le moment.`,
    cityOpticians: (city, label) => `Opticiens à ${city}${label} :`,
    noCity: (city, label) => `Je n'ai pas d'opticien Thélios à ${city}${label} pour le moment.`,
  ...
  en: {
    ...
    noPostal: (code) => `I don't have a Thélios optician at postal code ${code} right now.`,
    cityOpticians: (city, label) => `Opticians in ${city}${label}:`,
    noCity: (city, label) => `I don't have a Thélios optician in ${city}${label} right now.`,
